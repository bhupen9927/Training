(function () {
  try {
    ...
    live("html body [class*='SearchTopRightCss'] > button, [class*='Row-buttonsWrapper'] [data-id='SEARCH'], [class*='mobileButtonPanel'] [data-id='SEARCH']", 'click', function () {
      waitForElement(".lock-scroll #__next [class*='modalSearchContent'] [class*='typeHeadeInput-holder'] > div:first-child ", init, 100, 15000);
    });
    ...
    if (window.innerWidth < 1024) {
      waitForElement(".lock-scroll #__next [class*='modalSearchContent'] [class*='typeHeadeInput-holder'] > div:first-child ", init, 1000, 15000);
    }
