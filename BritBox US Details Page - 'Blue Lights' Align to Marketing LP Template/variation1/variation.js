...
<section class="section section-relative eg-meet-cast" id="page-block-7b71l6t3pzq" data-at="section">
  ...
  <div class="section-block">
    <div class="section-inner section-fit section-relative">
      <div class="widget item-absolute headline  " id="element-452" data-at="headline">
        <div class="contents">
          <h1>
            <span class="x_5d488fcf x_d5cc1063"><strong><span class="x_f2074b6c">Meet the Cast of Blue
                  Lights</span></strong></span>
          </h1>
        </div>
      </div>

      <div class="widget item-absolute  " id="element-561">
      ...
      <div class="widget item-absolute  " id="element-560">
        <div class="contents cropped item-block" data-at="image-cropp">
          <img class="item-content-box item-block image" data-at="image" alt=""
            src="//v.fastcdn.co/u/5149ab86/64936251-0-badge-3.png"
            data-src="//v.fastcdn.co/u/5149ab86/64936251-0-badge-3.png"
            data-retina-src="//v.fastcdn.co/u/5149ab86/64936251-0-badge-3.png"
            srcset="//v.fastcdn.co/u/5149ab86/64936251-0-badge-3.png 2x">
        </div>
      </div>
      ...
      <div class="widget item-absolute headline  " id="element-557" data-at="headline">
        <div class="contents">
          <h1>
            <span class="x_82ea7ee4 x_81e9cdbd"><strong>Grace Ellis</strong></span>
          </h1>
        </div>
      </div>

      <div class="widget item-absolute  " id="element-553">
        <div class="contents cropped item-block" data-at="image-cropp">
        </div>
      </div>
      ...
      <div class="widget item-absolute paragraph  " id="element-556" data-at="paragraph">
        <div class="contents">
          <p class="x_5319a2c7 x_8b9dcb22"><span class="x_f2074b6c">Selfless, empathetic, and an idealist at heart,
              Grace is beginning to harden on the job and is adjusting to life without her son, Cal, who has moved away
              for university. Still determined to go above and beyond in her role, she perhaps gives too much of herself
              away.</span></p>
        </div>
      </div>
      ...
      <div class="widget item-absolute headline  " id="element-532" data-at="headline">
        <div class="contents">
          <h1>
            <span class="x_82ea7ee4 x_81e9cdbd"><strong>Stevie Neil</strong></span>
          </h1>
        </div>
      </div>
      ...
      <div class="widget item-absolute paragraph  " id="element-531" data-at="paragraph">
        <div class="contents">
          <p class="x_5319a2c7 x_8b9dcb22"><span class="x_f2074b6c">Stevie is a brilliant and pragmatic response
              officer, firm when needed, but always fair. Previously dealing with the tough side of policing with his
              sense of humor, Stevie’s realist attitude is being tested with trauma from his past. And his feelings for
              Grace make things even more complicated.</span></p>
        </div>
      </div>
      ...
      <div class="widget item-absolute  " id="element-589">
        <div class="contents cropped item-block" data-at="image-cropp">
          <img class="item-content-box item-block image" data-at="image" alt=""
            src="//v.fastcdn.co/u/5149ab86/64936251-0-badge-3.png"
            data-src="//v.fastcdn.co/u/5149ab86/64936251-0-badge-3.png"
      ...
      <div class="widget item-absolute  " id="element-608">
        <div class="contents cropped item-block" data-at="image-cropp">
        </div>
      </div>
      ...
      <div class="widget item-absolute headline  " id="element-587" data-at="headline">
        <div class="contents">
          <h1>
            <span class="x_82ea7ee4 x_81e9cdbd"><strong>Annie Conlon</strong></span>
          </h1>
        </div>
      </div>
      ...
      <div class="widget item-absolute paragraph  " id="element-586" data-at="paragraph">
        <div class="contents">
          <p class="x_5319a2c7 x_8b9dcb22"><span class="x_f2074b6c">Settling into Blackthorn station, the section is
              Annie’s found family. Fiery yet kind, Annie is coping as best she can after having to leave home due to a
              death threat. But with her impulsive side as prominent as ever, she must decide which consequences are
              worth facing.</span></p>
        </div>
      </div>
      ...
      <div class="widget item-absolute headline  " id="element-604" data-at="headline">
        <div class="contents">
          <h1>
            <span class="x_82ea7ee4 x_81e9cdbd"><strong>Tommy Foster</strong></span>
          </h1>
        </div>
      </div>
      ...
      <div class="widget item-absolute paragraph  " id="element-603" data-at="paragraph">
        <div class="contents">
          <p class="x_5319a2c7 x_8b9dcb22"><span class="x_f2074b6c">Fiercely loyal and hardworking, Tommy is seduced by
              the world of intelligence policing. Once relying on analytical skills, Tommy has spent time on a fitness
              regime, boosting his confidence and making him more street savvy. But as he is drawn into this new side of
              the job, he faces a grave danger.</span></p>
        </div>
      </div>
