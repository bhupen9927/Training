(function () {
  try {
    ...
    function herosection() {
      ...
      <div class="eg-hero-section-wrapper">
        <div class="eg-hero-left">
            <div class="eg-review"><div class="eg-image"><img src="https://sitetunershosting.com/clients/AirDoctor/review_star.png"></div><span class="eg-text">1,300+ reviews</span></div>
            <h1><span>Breathe Cleaner,</span> <br> Healthier Air <span>Today</span></h1>
        ...
        <div class="eg-hero-right">
            <div class="eg-video-thumbnail">
                <img class="eg-doc-desk" src="https://sitetunershosting.com/clients/AirDoctor/Main_Content.png" alt="Dr. Rutland Thumbnail">
                <img class="eg-doc-mob" src="https://sitetunershosting.com/clients/AirDoctor/Main_Content.png" alt="Dr. Rutland Thumbnail">
    ...
    <div class="eg-hero-AsSeenOn">
      <p class="eg-asSeen-text">Featured IN</p>
      <div class="eg-asSeen-logos">
        <img class="eg-asSeen-img eg-newsweek" src="https://sitetunershosting.com/clients/AirDoctor/g4285.png">
        <img class="eg-asSeen-img eg-wired" src="https://sitetunershosting.com/clients/AirDoctor/Wired.png">
        <img class="eg-asSeen-img eg-msn" src="https://sitetunershosting.com/clients/AirDoctor/msn-logo%201.png">
        <img class="eg-asSeen-img eg-popular_science" src="https://sitetunershosting.com/clients/AirDoctor/Layer_1.png">
        <img class="eg-asSeen-img eg-news" src="https://sitetunershosting.com/clients/AirDoctor/enews-logo.png">
        <img class="eg-asSeen-img eg-cnn" src="https://sitetunershosting.com/clients/AirDoctor/cnn-logo.png">
      </div>
    </div>`
      ...
      if (window.innerWidth < 767) {
        document.querySelector('.eg-hero-section .eg-hero-right').insertAdjacentElement('afterend', document.querySelector('.eg-hero-section .eg-features-container'));
      }
      scroll();
    }
    ...
    function limitedTimeSection() {
      ...
      <div class="eg-section-header">
        <div class="eg-inner">
          <div class="eg-limited-time">Save 40% on the Air <br>Doctor 3500</div>
        </div>
        <div class="eg-inner">
          <p class="eg-bullets-title">Our Award-Winning Air Purifier</p>
          <ul>
            <li><span>Circulates the air</span> 4x/hour in 630 sq. ft. spaces and 2x/hour in 1,260 sq. ft. spaces.</li>
            <li><span>Captures particles</span> 100X smaller than HEPA standard.</li>
            <li><span>Whisper-jet fans</span> are 30% quieter than traditional air purifiers.</li>
            <li><span>Simple Touch Control Panel</span> with auto-mode sensors that auto-adjust based on air quality.</li>
          </ul>
          <div class="eg-instockmsg">
            <span>Select Model</span>
            <span><img src="https://sitetunershosting.com/clients/AirDoctor/Tick_icon.png"> In stock</span>
          </div>
        </div>
      </div>`;
      ...
      if (window.innerWidth < 767) {
        const sectionDesTitle = limitedSection.querySelector('.product_section-wrapper .eg-section-header .eg-bullets-title');
        const egLimited = document.querySelector('.product_section-wrapper > div > div:first-of-type');
        if (sectionDesTitle && egLimited) {
          sectionDesTitle.insertAdjacentElement('afterend', egLimited);
        }
      }
      ...
      buyNowBtns.forEach(buyNowBtn => {
        buyNowBtn.innerText = 'Buy Now & Save 40%';
      });

      waitForElement('.eg-3500-section .iot_upgrade_section .affirm_price_wrapper', function () {
        const priceWrapper = document.querySelectorAll('.eg-3500-section .iot_upgrade_section .affirm_price_wrapper');
        priceWrapper.forEach(function (element) {
          if (element.textContent.includes('Get it')) {
            element.textContent = element.textContent.replace('Get it', '12 easy payments');
          }
        });
      }, 50, 15000);
      ...
      let intv = setInterval(() => {
        ...
        if (mainImg) {
          mainImg.setAttribute('src', 'https://sitetunershosting.com/clients/AirDoctor/AD3500_Newsweek.png');
          mainImg.setAttribute("data-src", "https://sitetunershosting.com/clients/AirDoctor/AD3500_Newsweek.png");
        }
      }, 100);
