  ...
  try {
    ...
    wnd.allPds = [
      {
        ...
        "img": "https://demazin.com.au/wp-content/uploads/2023/05/Demazin-Cold-Flu-Cough-Day_Night-Capsules-24-bts-1.png",
      ...
      },
      {
        ...
        "img": "https://demazin.com.au/wp-content/uploads/2021/08/9310160822758-22-Demazin-Kids-6-Cough-Cold-Relief-bts-1.png",
      ...
      },
      {
        ...
        "img": "https://demazin.com.au/wp-content/uploads/2023/02/98368_DZ_A5986_9314057016350_1-bts-1.png",
    ...
    <div class="eg-content-wrapper_main">
        ...
        <div class="eg-grid_main">
            <div class="eg-grid_main-left">
                <div class="eg-grid_main-left-wrapper">
                    ...
                    <div class="eg-filter-popup-cta-group">
                        <button class="eg-clear-filters" type="button">Reset</button>
                        <button class="eg-search-filters" type="button">Apply filters</button>
                    </div>
                </div>
            </div>
            ...
            <div class="eg-filters-info eg-dummy">
                    <span class="eg-total-filters">Showing 15 items</span>
                </div>
    ...
    function updateProducts() {
      ...
      const ShowingMsgEl = document.querySelector('html body .eg-filters-info:not(.eg-dummy) .eg-total-filters');
      const ShowingMsgElDummy = document.querySelector('html body .eg-filters-info.eg-dummy .eg-total-filters');
      if (document.querySelector('html body .eg-grid_main-left .eg-group .eg-group-list-item.eg-checked')) {
        ShowingMsgEl.innerText = `Showing ${pds.length} items for`;
        ShowingMsgElDummy.innerText = '';
      } else {
        ShowingMsgEl.innerText = '';
        ShowingMsgElDummy.innerText = 'Showing 15 items';
      }
    }
