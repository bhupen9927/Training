...
<div class="eg-tabwrapper">
    ...
    // function comparepurifiers() {
    //   document.querySelector('.product-table .section-content  > div > div:first-child h4').innerText = 'Compare Our Purifiers';
    //   let interval = setInterval(() => {
    //     document.querySelector('.product-table .section-content > div > div:nth-child(2) img').setAttribute('src', 'https://sitetunershosting.com/clients/air/compare_purifiers.png');
    //     let comparepurifiers = `<p class='eg-comparetext'>* Harvard University Study cited by CDC recommends at least 4 air changes per hour to effectively remove viruses, bacteria, smoke, dust & pollen.** CADR (Clean Air Delivery Rate) is an objective measurement for comparing air filter performance, based on its ability to remove particulate matter. The higher the number, the more effective it will be. According to CDC guidance, CADR/cfm should be 2/3 of the total room size.*** Based on 24-hour daily usage.</p>`
    //     if (!document.querySelector('.eg-comparetext')) {
    //       document.querySelector('.product-table .section-content  > div > div:nth-child(2)').insertAdjacentHTML('afterend', comparepurifiers);
    //     }
    //   }, 50);
    ...
    function producttile() {
      let interval = setInterval(() => {
        let air3500 = document.querySelectorAll('#content>section:first-of-type .section-content > section:first-of-type .product_specification_wrapper > h5');
        air3500.forEach(element => {
          element.innerText = 'Up to 1,260 sq. ft. coverage';
        });
        document.querySelector('#content>section:first-of-type .section-content > section:first-of-type .product_specification_wrapper > div:first-of-type').innerText = 'High performance air purification for bedrooms, living rooms and kitchens';
        document.querySelector('#content>section:first-of-type .section-content > section:first-of-type .product_specification_wrapper > div:nth-of-type(2)').innerText = 'High performance air purification for bedrooms, living rooms and kitchens';

        let air2000 = document.querySelectorAll('#content>section:first-of-type .section-content > section:nth-of-type(2) .product_specification_wrapper > h5');
        air2000.forEach(element => {
          element.innerText = 'Up to 610 sq. ft. coverage';
        });
        document.querySelector('#content>section:first-of-type .section-content > section:nth-of-type(2) .product_specification_wrapper > div:nth-child(3)').innerText = 'Powerful air purification for medium/small rooms, nurseries and home offices';
        document.querySelector('#content>section:first-of-type .section-content > section:nth-of-type(2) .product_specification_wrapper > div:nth-child(2)').innerText = 'Powerful air purification for medium/small rooms, nurseries and home offices';

        let air1000 = document.querySelectorAll('#content>section:first-of-type .section-content > section:nth-of-type(4) .product_specification_wrapper');
        ...
        let air1000heading = document.querySelector('.section-content > section:nth-of-type(4) .product_section-wrapper > div > div:last-child .product_specification_wrapper');
        if (!document.querySelector('.eg-heading1000')) {
          air1000heading.insertAdjacentHTML('beforebegin', producttile1000);
        }

        waitForElement('#content>section:first-of-type .section-content>section:nth-of-type(3) #nu-custom-srt-desc135600', function () {
          let producttileheading = `<h5 class = 'eg-heading5500'>Up to 2,086 sq. ft. coverage</h5>`
          if (!document.querySelector('.eg-heading5500')) {
            document.querySelector('#content>section:first-of-type .section-content>section:nth-of-type(3) #nu-custom-srt-desc135600').insertAdjacentHTML('beforebegin', producttileheading);
          }
        }, 1000, 15000);
        document.querySelector('#content>section:first-of-type .section-content > section:nth-of-type(3) .product_specification_wrapper > div:nth-child(2)').innerText = 'Premium air purification for extra large spaces, high ceilings and open concepts';
        document.querySelector('#content>section:first-of-type .section-content > section:nth-of-type(3) .product_specification_wrapper > div:nth-child(1)').innerText = 'Premium air purification for extra large spaces, high ceilings and open concepts';
