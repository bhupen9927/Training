(function () {
  try {
    ...
    function init() {
        ...
        if (AD3500_desc) {
            AD3500_desc.innerHTML = `Our most popular model. The AirDoctor 3500 is perfect for <b>bedrooms, living rooms, kitchens.</b> Circulates the air <b>4x/hour in a 630 sq. ft. space</b> (as recommended by a Harvard University Study cited by CDC to effectively remove allergens like smoke, bacteria, viruses, dust, and pollen).`;
        }
        ...
        if (AD2000_desc) {
            AD2000_desc.innerHTML = `AirDoctor 2000 provides powerful purification for <b>small rooms, medium/small bedrooms, nurseries, and home offices.</b> Circulates the air <b>4x/hour in a 305 sq. ft. space</b> (as recommended by a Harvard University Study cited by CDC to effectively remove allergens like smoke, bacteria, viruses, dust, and pollen).`;
        }
        ...
        if (AD5500_desc) {
            AD5500_desc.innerHTML = `AirDoctor 5500 is our most powerful and quietest purifier. It is perfect for <b>extra large spaces, high ceilings and open concepts.</b> Circulates the air <b>4x/hour in a 1,001 sq. ft. space</b> (as recommended by a Harvard University Study cited by CDC to effectively remove allergens like smoke, bacteria, viruses, dust, and pollen).`;
        }

        const AD1000_desc = document.querySelector(".section-content > section:nth-of-type(4) .mob-hide-heading >div:nth-of-type(1)");
        if (AD1000_desc) {
            const newText = `Small and mighty purification that’s perfect for <b>small bedrooms, nurseries, home offices, and laundry rooms.</b> Circulates the air <b>4x/hour in a 285 sq. ft. space</b> (as recommended by a Harvard University Study cited by CDC to effectively remove allergens like smoke, bacteria, viruses, dust, and pollen). `;
