...
<path d="M17.5425 11.6568L19.4281 9.77123L10 0.34314L0.571899 9.77127L2.45752 11.6569L10 4.11437L17.5425 11.6568Z" fill="#21252980"/>
    ...
    function testEvents() {
      if (!document.querySelector('.eg-events-added')) {
        ...
        live('.brochure-datalayer', 'click', function () {
          document.body.classList.add('eg-v2')
        });
        live('.modal.form-modal#brochureModal .modal-dialog .close img', 'click', function () {
          document.body.classList.remove('eg-v2')
        });
