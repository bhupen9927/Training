(function () {
  try {
        ...
        <div class="eg-get-block">
            <div class="eg-qr-block">
              ...
              <div class="eg-get-container">
                ...
                <p class="eg-qr-body">Betashares Direct is the new investing platform designed to help you build wealth, your way.</p>
            ...
            <div class="eg-hide-desktop">
              <a id="get-action-hero" href="https://www.betashares.com.au/direct" class="eg-rl-button eg-mobile-get-button eg-w-button">Learn more</a>
            </div>
            <div class="eg-badge-pair">
              <a href="https://links.betashares.com.au/ios?route_source=https%3A%2F%2Fwww.betashares.com.au%2Fdirect&amp;anonymousId=4556725d-96f7-451b-bdd0-73caa0e70cf5" class="eg-pay-apps">
              ...
              <a href="https://links.betashares.com.au/android?route_source=https%3A%2F%2Fwww.betashares.com.au%2Fdirect&amp;anonymousId=4556725d-96f7-451b-bdd0-73caa0e70cf5" class="eg-pay-apps">
                <div class="eg-hide-mobile">
    ...
    function init2() {
      ...
      if (main) {
        main.insertAdjacentHTML('afterend', qrBlock);
      }
    }

    /* Initialize variation */
    if (window.location.pathname === '/') {
      waitForElement('#content > section:nth-child(3)', init, 50, 15000);
  }  
    if (window.location.href.indexOf('/education') !== -1) {
      waitForElement('#content +section', init2, 50, 15000);
    }
  } catch (e) {
