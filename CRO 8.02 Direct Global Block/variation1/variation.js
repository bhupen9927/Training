(function () {
  try {
    ...
    const qrBlock=`
        <div data-w-id="b340a9dc-8f7c-3cd9-c1a8-43e97dbcc9cb" 
            class="eg-get-block" style="transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d; opacity: 1;">
    ...
    /* Variation Init */
    function init() {
        if (window.location.href === "https://www.betashares.com.au/explore-funds/") {
            const exploreETF = document.querySelector('#content > section:nth-child(5)');
            if (exploreETF) {
